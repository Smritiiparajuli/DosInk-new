  ...
  return (
    <>
      ...
      <div className="gap-8 items-center py-4 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-8 lg:px-6 z-100">
        <img className="w-full" src="/images/discussion.png" alt="Discussion" />
        <div className="mt-4 md:mt-0">
          ...
          <p className="mb-6 font-light">
            ...
            the right tech strategies. From planning to execution, we’re by your
            side to build a future-ready digital roadmap.
          </p>
        </div>
      </div>
    </>
